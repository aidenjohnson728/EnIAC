...
contextBridge.exposeInMainWorld('api', {
  ...
  createDefaultProject: (templateId, overrides) => ipcRenderer.invoke('projects:createDefault', templateId, overrides),
  createCustomTemplate: (data) => ipcRenderer.invoke('templates:create', data),
  exportTemplateForm: (templateId) => ipcRenderer.invoke('templates:exportForm', templateId),
  importTemplateForm: () => ipcRenderer.invoke('templates:importForm'),
  ...
  previewImportProjectFile: () => ipcRenderer.invoke('sync:previewImportFile'),
  importProjectAsNew: (data, chosenName) => ipcRenderer.invoke('sync:importAsNew', data, chosenName),
