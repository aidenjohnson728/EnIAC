...
export const api = isElectron ? window.api : {
  ...
  getResultsComparisonData: async () => ({ mine: [], imported: [] }),
  ...
  countFormUsage: async () => ({ mediaTypes: 0, reviews: 0, responses: 0 }),
  ...
  countInstructionUsage: async () => ({ mediaTypes: 0, reviews: 0 }),
  getInstructionFileUrl: async () => null,
  getUploadedPdfUrl: async () => null,
  ...
  setMediaLink: async () => ({ linked: true, nameChanged: false, hasReviews: false, currentName: null, newName: null, encounterId: null }),
  applyRelinkRename: async () => ({ renamedMedia: true, renamedEncounter: false }),
