...
export const api = isElectron ? window.api : {
  ...
  createSampleProject: async () => { const p = { id: Date.now(), name: '📘 Sample Tutorial Project', created_at: new Date().toISOString() }; mock.projects.push(p); return { id: p.id, alreadyExisted: false } },
