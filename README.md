...
> If macOS says "SDMo cannot be opened because it is from an unidentified developer", open **System Settings → Privacy & Security**, scroll down, and click **Open Anyway**. This is expected for apps not distributed through the Mac App Store.
